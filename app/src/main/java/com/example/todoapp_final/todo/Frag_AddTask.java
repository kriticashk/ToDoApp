...
public class Frag_AddTask extends Fragment {
    ...
    public static Frag_AddTask newInstance() {
        return new Frag_AddTask();
    }
    public Frag_AddTask() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        submitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                TodoAssign todo = new TodoAssign(title, desc, priority, date);
