...
import com.example.todoapp_final.MainActivity;
import com.example.todoapp_final.R;
...
public class TodoFragment extends Fragment {
    ...
    private List<TodoAssign> mTaskEntries;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        this.adapter = new TodoListAdapter(getContext(), new TodoListAdapter.TaskCallBack() {
            ...
            @Override
            public void onUpdate(TodoAssign todo) {
        ...
        new ItemTouchHelper(new ItemTouchHelper.SimpleCallback(0, ItemTouchHelper.LEFT | ItemTouchHelper.RIGHT) {
            ...
            public void onSwiped(@NonNull RecyclerView.ViewHolder viewHolder, int direction) {
                ...
                List<TodoAssign> todoList = adapter.mTodos;
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mTodoViewModel.getTodos().observe(getViewLifecycleOwner(), new Observer<List<TodoAssign>>() {
            @Override
            public void onChanged(@Nullable final List<TodoAssign> todos) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                getActivity().getSupportFragmentManager().beginTransaction()
                        .replace(R.id.container, Frag_AddTask.newInstance())
                        .addToBackStack(null)
                        .commit();
